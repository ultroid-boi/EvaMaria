...
API_ID = int(environ.get('API_ID', '10923414'))
API_HASH = environ.get('API_HASH', 'd2a67817acddcb3bec2e94392994ddf4')
BOT_TOKEN = environ.get('BOT_TOKEN', '5878343064:AAECXfsIjuTPxUzz9vd_97JGLKUxLLfD5AQ')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2100780959').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001741992288').split()]
